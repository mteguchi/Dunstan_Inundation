...
inund$dt <- c(0, dt)
inund$datsetID <- cumsum(ifelse(inund$dt < 2, 0, 1)) + 1
...
Explore data with making some plots. In the previous data exploiration, I found that variability among transects is quite small. So, I can pool them to model. 
