...
parameters <- c("b0", "b1", "sigma.y", "deviance")

#if (!file.exists("RData/exp_month_year_2.rds")){
...
#   saveRDS(jm.2, file = "RData/exp_month_year_2.rds")  
# } else {
#   jm.2 <- readRDS("RData/exp_month_year_2.rds")
# }
...
pred.list <- extract.prediction.2(zm = jm.3, jags.data = jags.data)
