...
Max_Height,  Mean_Max_Height_Per_Event, Berm_Dist
...
b[3] (Berm_Dist) < 0; A negative relationship between Berm_Dist and p_success

Smaller maximum tide height of inundation events, greater mean maximum tide height per event, and greater Berm_Dist result in low hatching success rate. 

Does this make sense...?

```{r}
bayesplot::mcmc_trace(jm.V3$samples, c("b[1]", "b[2]", "b[3]", "b[4]"))
```

Not great trace plots, except the intercept... 

```{r}
bayesplot::mcmc_dens(jm.V3$samples, c("b[1]", "b[2]", "b[3]", "b[4]"))
```
